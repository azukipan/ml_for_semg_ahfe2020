...
def main():
    ...
    with open('sim_target_trajectory_right_uturn.txt', "w") as results:
    ...
    f = [line.rstrip('\n') for line in open('D:/Research Projects/sEMG_control_for_automobiles/putemg-downloader/putemg_examples/total_processing_time_wrist_extension.txt')][2:]
